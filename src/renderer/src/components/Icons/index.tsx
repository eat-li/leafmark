...
// 模板图标 — 空白笔记
export function IconTemplateBlank(props: IconProps): React.ReactNode {
  return wrap(
    props,
    <>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
...
// 模板图标 — 日记（日历）
export function IconTemplateDiary(props: IconProps): React.ReactNode {
  return wrap(
    props,
    <>
...
// 模板图标 — 会议记录（剪贴板）
export function IconTemplateMeeting(props: IconProps): React.ReactNode {
  return wrap(
    props,
    <>
...
// 模板图标 — 读书笔记（书本）
export function IconTemplateBook(props: IconProps): React.ReactNode {
  return wrap(
    props,
    <>
...
// 模板图标 — 自定义模板（文件 + 小星标）
export function IconTemplateCustom(props: IconProps): React.ReactNode {
  return wrap(
    props,
    <>
      <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
