...
<title>${title}</title>
<style>
  body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans SC', 'PingFang SC', 'Microsoft YaHei', sans-serif; max-width: 760px; margin: 0 auto; padding: 32px; line-height: 1.85; color: #1e2d33; font-size: 15px; }
  h1, h2, h3, h4, h5, h6 { margin: 1.6em 0 0.6em; font-weight: 700; line-height: 1.3; }
  h1 { font-size: 2em; padding-bottom: 0.35em; border-bottom: 2px solid #0e8a7a; color: #0e8a7a; }
  h2 { font-size: 1.5em; padding-bottom: 0.3em; border-bottom: 1px solid #cdd8dc; }
  h3 { font-size: 1.25em; }
  p { margin: 0.9em 0; }
  a { color: #0e8a7a; text-decoration: none; }
  code { background: #dbe3e6; padding: 2px 7px; border-radius: 3px; font-family: 'JetBrains Mono', 'Fira Code', monospace; font-size: 0.88em; color: #0e8a7a; border: 1px solid #cdd8dc; }
  pre { margin: 1.2em 0; border-radius: 8px; overflow-x: auto; border: 1px solid #cdd8dc; }
  pre code { display: block; padding: 18px 20px; background: #dbe3e6; color: #1e2d33; border: none; font-size: 0.87em; line-height: 1.6; }
  blockquote { margin: 1em 0; padding: 0.6em 1.2em; border-left: 3px solid #0e8a7a; background: rgba(14,138,122,0.06); color: #4a6069; border-radius: 0 5px 5px 0; }
  ...
  th, td { border: 1px solid #cdd8dc; padding: 8px 14px; text-align: left; }
  th { background: #e6ecee; font-weight: 600; }
  hr { border: none; height: 1px; background: linear-gradient(to right, transparent, #cdd8dc, transparent); margin: 2.5em 0; }
